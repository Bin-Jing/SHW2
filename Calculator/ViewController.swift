...
class ViewController: UIViewController {
    ...
    @IBAction func operatorButtonClicked(_ sender: UIButton) {
        ...
        case 1106: // root
            try! self.core.addStep(xRootOfy)
        default:
            fatalError("Unknown operator button: \(sender)")
        }
    }
    public func xRootOfy(_ x: Double,_ y: Double) -> Double{
    ...
    @IBAction func exponentialBtn(_ sender: UIButton) {
    ...
    @IBAction func percentBtn(_ sender: UIButton) {
        ...
        if(currentNumber == 0){
            ...
            self.displayLabel.text = String((currentNumber/100).displayString)
        }
    }
    @IBAction func logBtn(_ sender: UIButton) {
        ...
        if(currentNumber == 0){
            ...
            self.displayLabel.text = String(log10(currentNumber).displayString)
        }
    }
